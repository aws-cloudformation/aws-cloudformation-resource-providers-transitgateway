...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_Error() {
        ...
        when(proxyClient.client().deleteTransitGatewayPrefixListReference(any(DeleteTransitGatewayPrefixListReferenceRequest.class))).thenThrow(exception);
    ...
    public void handleRequest_NotFound() {
        ...
        AwsServiceException exception = AwsServiceException.builder().awsErrorDetails(errorDetails).build();
        when(proxyClient.client().getTransitGatewayPrefixListReferences(any(GetTransitGatewayPrefixListReferencesRequest.class))).thenReturn(MOCKS.describeResponse()).thenReturn(MOCKS.describeResponse());
        when(proxyClient.client().deleteTransitGatewayPrefixListReference(any(DeleteTransitGatewayPrefixListReferenceRequest.class))).thenThrow(exception);
