...
public class CreateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        when(proxyClient.client().createTransitGatewayPrefixListReference(any(CreateTransitGatewayPrefixListReferenceRequest.class))).thenReturn(MOCKS.createResponse());
    ...
    public void handleRequest_Error() {
        ...
        when(proxyClient.client().createTransitGatewayPrefixListReference(any(CreateTransitGatewayPrefixListReferenceRequest.class))).thenThrow(exception);

        ResourceModel model = MOCKS.modelWithFakeProperties();
