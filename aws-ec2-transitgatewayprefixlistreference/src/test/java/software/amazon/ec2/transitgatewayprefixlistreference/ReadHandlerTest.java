...
public class ReadHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_Error() {
        ...
        when(proxyClient.client().getTransitGatewayPrefixListReferences(any(GetTransitGatewayPrefixListReferencesRequest.class))).thenThrow(exception);
        ResourceModel model = MOCKS.model();
    ...
    @Test
    public void handleRequest_DELETING() {
