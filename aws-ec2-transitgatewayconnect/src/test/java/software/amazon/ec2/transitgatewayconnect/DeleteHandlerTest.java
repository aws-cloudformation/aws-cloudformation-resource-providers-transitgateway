...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        when(proxyClient.client().deleteTransitGatewayConnect(any(DeleteTransitGatewayConnectRequest.class))).thenReturn(MOCKS.deleteResponse());
        when(proxyClient.client().describeTransitGatewayConnects(any(DescribeTransitGatewayConnectsRequest.class))).thenReturn(MOCKS.describeResponse()).thenReturn(MOCKS.describeResponse("deleted"));
    ...
    public void handleRequest_Error() {
        ...
        when(proxyClient.client().deleteTransitGatewayConnect(any(DeleteTransitGatewayConnectRequest.class))).thenThrow(exception);
        when(proxyClient.client().describeTransitGatewayConnects(any(DescribeTransitGatewayConnectsRequest.class))).thenReturn(MOCKS.describeResponse()).thenReturn(MOCKS.describeResponse("deleted"));
