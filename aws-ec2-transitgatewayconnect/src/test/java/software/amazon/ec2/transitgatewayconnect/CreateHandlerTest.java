...
public class CreateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        when(proxyClient.client().createTransitGatewayConnect(any(CreateTransitGatewayConnectRequest.class))).thenReturn(MOCKS.createResponse());
        when(proxyClient.client().describeTransitGatewayConnects(any(DescribeTransitGatewayConnectsRequest.class))).thenReturn(MOCKS.describeResponse());
