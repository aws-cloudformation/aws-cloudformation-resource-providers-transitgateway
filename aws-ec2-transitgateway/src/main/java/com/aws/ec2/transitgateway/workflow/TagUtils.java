...
public class TagUtils {
    public static List<com.aws.ec2.transitgateway.Tag> sdkTagsToCfnTags(final List<Tag> tags) {
        if(tags == null) {
    ...
    public static List<Tag> cfnTagsToSdkTags(final List<com.aws.ec2.transitgateway.Tag> tags) {
        if (tags == null) {
            return new ArrayList<>();
        }
        return tags.stream()
