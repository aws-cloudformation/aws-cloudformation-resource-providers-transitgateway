...
public class CreateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        when(proxyClient.client().createTransitGateway(any(CreateTransitGatewayRequest.class))).thenReturn(MOCKS.createResponse(newTags));
        when(proxyClient.client().describeTransitGateways(any(DescribeTransitGatewaysRequest.class))).thenReturn(MOCKS.describeResponse(newTags));
