...
public class TagUtils {
    public static List<software.amazon.ec2.transitgatewaypeeringattachment.Tag> sdkTagsToCfnTags(final List<Tag> tags) {
        if(tags == null) {
            return new ArrayList<>();
        }
        return tags.stream()
            .map(e -> software.amazon.ec2.transitgatewaypeeringattachment.Tag.builder()
                .key(e.key())
                .value(e.value())
                .build())
    ...
    public static List<Tag> cfnTagsToSdkTags(final List<software.amazon.ec2.transitgatewaypeeringattachment.Tag> tags) {
        if (tags == null) {
            return new ArrayList<>();
        }
        return tags.stream()
    ...
    public static List<TagSpecification> translateTagsToTagSpecifications(final List<Tag> tags) {
        return Arrays.asList(TagSpecification.builder()
            .resourceType("transit-gateway-peering-attachment")
            .tags(tags).build());
    }
    ...
    public static List<Tag> difference(List<software.amazon.ec2.transitgatewaypeeringattachment.Tag>  tags1, List<software.amazon.ec2.transitgatewaypeeringattachment.Tag> tags2) {
