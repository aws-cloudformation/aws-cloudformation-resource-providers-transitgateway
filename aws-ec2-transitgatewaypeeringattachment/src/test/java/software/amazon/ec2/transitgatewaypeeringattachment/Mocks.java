...
public class Mocks {
    ...
    public  ResourceModel modelWithFakeProperties(List<Tag> tags, String state) {
        return ResourceModel.builder()
                .creationTime(this.currentTime.toString())
                .state(state)
                .peerAccountId(this.peerAccount)
    ...
    public TransitGatewayPeeringAttachment sdkModel(List<Tag> tags, String state) {
        return TransitGatewayPeeringAttachment.builder()
                ...
                .state(state)
                .accepterTgwInfo(software.amazon.awssdk.services.ec2.model.PeeringTgwInfo.builder().ownerId(this.peerAccount).region(this.peerRegion).transitGatewayId(this.peerTransitGatewayId).build())
