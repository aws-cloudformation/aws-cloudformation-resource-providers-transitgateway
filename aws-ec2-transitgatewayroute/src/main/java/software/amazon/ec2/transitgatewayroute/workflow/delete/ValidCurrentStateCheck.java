...
import software.amazon.ec2.transitgatewayroute.workflow.ValidCurrentStateCheckBase;
...
public class ValidCurrentStateCheck extends ValidCurrentStateCheckBase {
    ...
    protected List<String> validStates() {
        ...
        list.add(TransitGatewayRouteState.BLACKHOLE.toString());
        list.add(TransitGatewayRouteState.DELETING.toString());
        return list;
    }
