...
public class TagUtilsTest extends AbstractTestBase {
    ...
    public void sdkTagsToCfnTags() {
        ...
        final List<software.amazon.ec2.transitgatewayroute.Tag> cfnTags = TagUtils.sdkTagsToCfnTags(sdkTags);
    ...
    public void sdkTagsToCfnTagsWhenNull() {
        final List<software.amazon.ec2.transitgatewayroute.Tag> cfnTags = TagUtils.sdkTagsToCfnTags(null);
