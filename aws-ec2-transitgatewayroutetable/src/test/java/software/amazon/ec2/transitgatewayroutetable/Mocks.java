...
public class Mocks {
    ...
    public TransitGatewayRouteTable sdkModel(List<Tag> tags, String state) {
        return TransitGatewayRouteTable.builder()
                .transitGatewayId(this.parentIdentifier)
    ...
    public TransitGatewayRouteTable sdkModel(String state) {
        final List<software.amazon.awssdk.services.ec2.model.Tag> tags = new ArrayList<>();
        return this.sdkModel(tags, state);
    }

    public TransitGatewayRouteTable sdkModel(List<Tag> tags) {
        return this.sdkModel(tags, "available");
    }

    public TransitGatewayRouteTable sdkModel() {
    ...
    public DescribeTransitGatewayRouteTablesResponse describeResponse(String state) {
        final List<software.amazon.awssdk.services.ec2.model.Tag> tags = new ArrayList<>();
        return this.describeResponse(tags, state);
    }

    public DescribeTransitGatewayRouteTablesResponse describeResponse(List<Tag> tags) {
        return this.describeResponse(tags, "available");
    }

    public DescribeTransitGatewayRouteTablesResponse describeResponse() {
