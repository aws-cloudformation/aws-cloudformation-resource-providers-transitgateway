...
public class ValidateCurrentState extends ValidateCurrentStateBase {
    public ValidateCurrentState(AmazonWebServicesClientProxy proxy, ResourceHandlerRequest<ResourceModel> request, com.aws.ec2.transitgatewayvpcattachment.CallbackContext callbackContext, ProxyClient<Ec2Client> client, Logger logger) {
