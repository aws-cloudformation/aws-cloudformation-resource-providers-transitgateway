# AWS::EC2::TransitGatewayMulticastGroup

The AWS::EC2::TransitGatewayMulticastGroup registers and deregisters members and sources (network interfaces) with the transit gateway multicast group
...
<pre>
{
    "Type" : "AWS::EC2::TransitGatewayMulticastGroup",
    "Properties" : {
