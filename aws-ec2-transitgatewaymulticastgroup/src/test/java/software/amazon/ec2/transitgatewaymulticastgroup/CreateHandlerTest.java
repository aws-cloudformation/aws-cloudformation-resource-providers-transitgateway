...
public class CreateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccessGroupMember() {
        ...
        when(proxyClient.client().registerTransitGatewayMulticastGroupMembers(any(RegisterTransitGatewayMulticastGroupMembersRequest.class))).thenReturn(MOCKS.createGroupMemberResponse(mockMap));
