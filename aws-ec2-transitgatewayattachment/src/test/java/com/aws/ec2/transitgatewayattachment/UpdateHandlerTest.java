...
public class UpdateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_CreateTagsSuccess() {
        ...
        when(proxyClient.client().describeTransitGatewayVpcAttachments(any(DescribeTransitGatewayVpcAttachmentsRequest.class)))
        ...
        final ResourceModel model = MOCKS.model(newTags);
    ...
    public void handleRequest_ChangeTagsSuccess() {
        ...
        final ResourceModel model = MOCKS.model(tags2);
