...
public class TagUtilsTest extends AbstractTestBase {
    ...
    public void sdkTagsToCfnTags() {
        ...
        final List<com.aws.ec2.transitgatewayattachment.Tag> cfnTags = TagUtils.sdkTagsToCfnTags(sdkTags);
    ...
    public void sdkTagsToCfnTagsWhenNull() {
        final List<com.aws.ec2.transitgatewayattachment.Tag> cfnTags = TagUtils.sdkTagsToCfnTags(null);
