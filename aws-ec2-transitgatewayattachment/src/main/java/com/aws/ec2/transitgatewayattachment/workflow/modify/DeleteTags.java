...
public class DeleteTags {
    ...
    private List<Tag> tagsToDelete(ResourceModel model) {
        ...
        final List<com.aws.ec2.transitgatewayattachment.Tag> currTags = TagUtils.mergeResourceModelAndStackTags(model.getTags(), this.request.getDesiredResourceTags());
