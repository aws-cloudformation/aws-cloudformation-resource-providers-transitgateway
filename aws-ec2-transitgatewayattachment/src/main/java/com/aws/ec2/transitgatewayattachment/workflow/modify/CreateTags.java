...
public class CreateTags {
    ...
    private List<Tag> tagsToCreate(ResourceModel model) {
        ...
        List<com.aws.ec2.transitgatewayattachment.Tag> currTags = com.aws.ec2.transitgatewayattachment.workflow.TagUtils.mergeResourceModelAndStackTags(model.getTags(), this.request.getDesiredResourceTags());
        return TagUtils.difference(currTags, prevTags);
    }

    protected ProgressEvent<ResourceModel, com.aws.ec2.transitgatewayattachment.CallbackContext>  handleError(CreateTagsRequest awsRequest, Exception exception, ProxyClient<Ec2Client> client, ResourceModel model, CallbackContext context) {
