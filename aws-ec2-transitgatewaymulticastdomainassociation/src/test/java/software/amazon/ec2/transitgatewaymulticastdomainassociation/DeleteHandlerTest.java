...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        when(proxyClient.client().disassociateTransitGatewayMulticastDomain(any(DisassociateTransitGatewayMulticastDomainRequest.class))).thenReturn(MOCKS.deleteResponse());
        when(proxyClient.client().getTransitGatewayMulticastDomainAssociations(any(GetTransitGatewayMulticastDomainAssociationsRequest.class))).thenReturn(MOCKS.describeResponse()).thenReturn(MOCKS.describeResponse()).thenReturn(MOCKS.describeResponse("disassociated")).thenReturn(MOCKS.emptyReadResponse());
    ...
    public void handleRequest_Error() {
        ...
        when(proxyClient.client().disassociateTransitGatewayMulticastDomain(any(DisassociateTransitGatewayMulticastDomainRequest.class))).thenThrow(exception);
        ResourceModel model = MOCKS.model();
