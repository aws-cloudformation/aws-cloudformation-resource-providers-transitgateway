...
public class ValidCurrentStateCheckBase {
    ...
    protected ProgressEvent<ResourceModel, CallbackContext> failure() {
        ...
        if(this.currentState().equals(TransitGatewayMulitcastDomainAssociationState.DISASSOCIATED.toString())) {
    ...
    protected String currentState() {
        if(this._currentState != null) {
            ...
            return this._currentState = model==null ? TransitGatewayMulitcastDomainAssociationState.DISASSOCIATED.toString() : this.makeRequest().getState();
        }
    }
