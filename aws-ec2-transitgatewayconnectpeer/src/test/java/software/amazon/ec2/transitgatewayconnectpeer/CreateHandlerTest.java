...
public class CreateHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        when(proxyClient.client().createTransitGatewayConnectPeer(any(CreateTransitGatewayConnectPeerRequest.class))).thenReturn(MOCKS.createResponse());
        when(proxyClient.client().describeTransitGatewayConnectPeers(any(DescribeTransitGatewayConnectPeersRequest.class))).thenReturn(MOCKS.describeResponse());
    ...
    public void handleRequest_Error() {
        ...
        when(proxyClient.client().createTransitGatewayConnectPeer(any(CreateTransitGatewayConnectPeerRequest.class))).thenThrow(exception);
