...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        when(proxyClient.client().deleteTransitGatewayConnectPeer(any(DeleteTransitGatewayConnectPeerRequest.class))).thenReturn(MOCKS.deleteResponse());
        when(proxyClient.client().describeTransitGatewayConnectPeers(any(DescribeTransitGatewayConnectPeersRequest.class))).thenReturn(MOCKS.describeResponse()).thenReturn(MOCKS.describeResponse("deleted"));
    ...
    public void handleRequest_Error() {
        ...
        when(proxyClient.client().deleteTransitGatewayConnectPeer(any(DeleteTransitGatewayConnectPeerRequest.class))).thenThrow(exception);
        when(proxyClient.client().describeTransitGatewayConnectPeers(any(DescribeTransitGatewayConnectPeersRequest.class))).thenReturn(MOCKS.describeResponse()).thenReturn(MOCKS.describeResponse("deleted"));
