...
public class Mocks {
    ...
    public Mocks(
        ...
        this.primaryIdentifier = "tgw-connect-peer-02bb79002EXAMPLE";
    ...
    public  ResourceModel modelWithoutCreateOnlyProperties(List<Tag> tags, String state) {
        return ResourceModel.builder()
                .transitGatewayConnectPeerId(this.primaryIdentifier)
                .creationTime(this.currentTime.toString())
                .state(state)
                .connectPeerConfiguration(TransitGatewayConnectPeerConfiguration.builder().build())
    ...
    public TransitGatewayConnectPeer sdkModel(List<Tag> tags, String state) {
        return TransitGatewayConnectPeer.builder()
                .transitGatewayConnectPeerId(this.primaryIdentifier)
                .connectPeerConfiguration(software.amazon.awssdk.services.ec2.model.TransitGatewayConnectPeerConfiguration.builder().bgpConfigurations(TransitGatewayAttachmentBgpConfiguration.builder().build()).build())
                .transitGatewayAttachmentId(this.parentIdentifier)
    ...
    public TransitGatewayConnectPeer sdkModel(String state) {
        final List<software.amazon.awssdk.services.ec2.model.Tag> tags = new ArrayList<>();
        return this.sdkModel(tags, state);
    }

    public TransitGatewayConnectPeer sdkModel(List<Tag> tags) {
        return this.sdkModel(tags, "available");
    }

    public TransitGatewayConnectPeer sdkModel() {
        return this.sdkModel(new ArrayList<>(), "available");
    }

    public DescribeTransitGatewayConnectPeersResponse describeResponse(List<Tag> tags, String state) {
        return DescribeTransitGatewayConnectPeersResponse.builder()
    ...
    public DescribeTransitGatewayConnectPeersResponse describeResponse(String state) {
        final List<software.amazon.awssdk.services.ec2.model.Tag> tags = new ArrayList<>();
        return this.describeResponse(tags, state);
    }

    public DescribeTransitGatewayConnectPeersResponse describeResponse(List<Tag> tags) {
        return this.describeResponse(tags, "available");
    }

    public DescribeTransitGatewayConnectPeersResponse describeResponse() {
    ...
    public DeleteTransitGatewayConnectPeerResponse deleteResponse() {
        return DeleteTransitGatewayConnectPeerResponse.builder()
            .transitGatewayConnectPeer(this.sdkModel())
            .build();
    }

    public CreateTransitGatewayConnectPeerResponse createResponse() {
        return CreateTransitGatewayConnectPeerResponse.builder()
            .transitGatewayConnectPeer(this.sdkModel())
            .build();
    }
