...
public class TagUtils {
    public static List<com.aws.ec2.transitgatewaymulticastdomain.Tag> sdkTagsToCfnTags(final List<Tag> tags) {
        if(tags == null) {
            return new ArrayList<>();
        }
        return tags.stream()
            .map(e -> com.aws.ec2.transitgatewaymulticastdomain.Tag.builder()
                .key(e.key())
                .value(e.value())
                .build())
    ...
    public static List<Tag> cfnTagsToSdkTags(final List<com.aws.ec2.transitgatewaymulticastdomain.Tag> tags) {
        if (tags == null) {
            return new ArrayList<>();
        }
        return tags.stream()
    ...
    public static List<TagSpecification> cfnTagsToSdkTagSpecifications(final List<com.aws.ec2.transitgatewaymulticastdomain.Tag> tags) {
    ...
    public static List<Tag> difference(List<com.aws.ec2.transitgatewaymulticastdomain.Tag>  tags1, List<com.aws.ec2.transitgatewaymulticastdomain.Tag> tags2) {
