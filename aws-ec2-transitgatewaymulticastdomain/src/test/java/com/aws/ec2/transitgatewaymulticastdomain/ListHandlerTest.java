...
public class ListHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        final ResourceModel expectedResult = ResourceModel.builder()
                .transitGatewayMulticastDomainId(MOCKS.primaryIdentifier)
                .build();
    ...
    public void handleRequest_Error() {
        ...
        when(proxyClient.client().describeTransitGatewayMulticastDomains(any(DescribeTransitGatewayMulticastDomainsRequest.class))).thenThrow(exception);
