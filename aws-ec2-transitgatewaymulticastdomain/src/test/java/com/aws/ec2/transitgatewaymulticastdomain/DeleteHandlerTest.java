...
public class DeleteHandlerTest extends AbstractTestBase {
    ...
    public void handleRequest_SimpleSuccess() {
        ...
        when(proxyClient.client().deleteTransitGatewayMulticastDomain(any(DeleteTransitGatewayMulticastDomainRequest.class))).thenReturn(MOCKS.deleteResponse());
        when(proxyClient.client().describeTransitGatewayMulticastDomains(any(DescribeTransitGatewayMulticastDomainsRequest.class))).thenReturn(MOCKS.describeResponse()).thenReturn(MOCKS.describeResponse("deleted"));
    ...
    public void handleRequest_Error() {
        ...
        when(proxyClient.client().deleteTransitGatewayMulticastDomain(any(DeleteTransitGatewayMulticastDomainRequest.class))).thenThrow(exception);
        when(proxyClient.client().describeTransitGatewayMulticastDomains(any(DescribeTransitGatewayMulticastDomainsRequest.class))).thenReturn(MOCKS.describeResponse()).thenReturn(MOCKS.describeResponse("deleted"));
