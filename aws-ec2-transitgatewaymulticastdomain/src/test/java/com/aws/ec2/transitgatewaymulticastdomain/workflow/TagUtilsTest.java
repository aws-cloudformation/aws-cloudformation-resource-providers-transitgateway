...
import com.aws.ec2.transitgatewaymulticastdomain.AbstractTestBase;
...
public class TagUtilsTest extends AbstractTestBase {
    ...
    public void sdkTagsToCfnTags() {
        ...
        final List<com.aws.ec2.transitgatewaymulticastdomain.Tag> cfnTags = TagUtils.sdkTagsToCfnTags(sdkTags);
    ...
    public void sdkTagsToCfnTagsWhenNull() {
        final List<com.aws.ec2.transitgatewaymulticastdomain.Tag> cfnTags = TagUtils.sdkTagsToCfnTags(null);
